-- =============================================================================
-- STEP 1 — Create migration infrastructure tables in remitm database.
--           These are DDL statements (auto-committed, cannot be rolled back).
--           Run ONCE before the migration procedure.
--
-- Execute inside container:
--   docker exec -i remitm-mysql mysql -uroot -proot remitm < 01_infrastructure.sql
-- =============================================================================
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Migrated from remitm_old.remit_one — RemitOne API integration log';
