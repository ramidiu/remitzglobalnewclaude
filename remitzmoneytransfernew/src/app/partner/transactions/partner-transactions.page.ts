...
@Component({
  ...
  styles: [`
    ...
    .pt-tab:hover { color: #1B3571; }
    .pt-tab--active { color: #1B3571; border-bottom-color: #1B3571; }
    ...
    .action-btn--info:hover { background: #f9fafb; color: #1B3571; border-color: #98a2b3; }
