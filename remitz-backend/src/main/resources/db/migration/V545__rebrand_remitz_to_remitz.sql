-- ============================================================================
-- V545: Rebrand DB-seeded data from "Remitz" / "Layla" to "Remitz".
-- ----------------------------------------------------------------------------
...
-- resulting DATA to the new "Remitz" brand and the remitz.com domain.
...
SET body_template =
        REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(body_template,
            'remitz.co.uk', 'remitz.com'),
            'laylamoneytransfer.co.uk', 'remitz.com'),
            'laylamoneytransfer.com', 'remitz.com'),
            'layla.money', 'remitz.com'),
            'Remitz', 'Remitz'),
            'remitz', 'remitz'),
            'Layla', 'Remitz'),
            'layla', 'remitz'),
