...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // email links/logo (a public host like www.remitz.com), but the browser origin calling
        ...
        config.setAllowedOrigins(List.of(
            frontendUrl,
            "https://remitz.com",
            "https://www.remitz.com",
            "https://global.remitz.com",
            "http://localhost:8096",   // Docker frontend (remitz stack)
            "http://localhost:8100",
            "http://localhost:4200",
            "http://localhost",
