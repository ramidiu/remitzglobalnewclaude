package com.remitz.modules.payout.zeepay.service;
...
import com.remitz.modules.payout.zeepay.config.ZeepayConfig;
...
import com.remitz.modules.payout.zeepay.dto.ZeepayServiceType;
...
public class ZeepayService {
    ...
    // ------------------------------------------------------------------
    // Auto-disburse (build from beneficiary — like the old laylaremitz code)
    // ------------------------------------------------------------------

    /**
     * Auto-disburse a transaction via Zeepay, building the request from the transaction's
     * BENEFICIARY exactly like the old laylaremitz zeepay{Bank,Wallet,Pickup}Request:
