package com.remitz.modules.payin.fire.controller;

import com.remitz.common.enums.ActorType;
import com.remitz.common.enums.TransactionStatus;
import com.remitz.modules.payin.fire.dto.FireDtos.PaymentRequestBody;
import com.remitz.modules.payin.fire.dto.FireDtos.PaymentRequestResponse;
import com.remitz.modules.payin.fire.dto.FireDtos.UpdatePaymentBody;
import com.remitz.modules.payin.fire.entity.FirePaymentEntity;
import com.remitz.modules.payin.fire.repository.FirePaymentRepository;
import com.remitz.modules.payin.fire.service.FireService;
...
public class FireController {
    ...
    public ResponseEntity<?> createPaymentRequest(@RequestBody PaymentRequestBody body) {
        ...
        try {
            ...
            String description = "Remitz payment " + referenceNumber;
