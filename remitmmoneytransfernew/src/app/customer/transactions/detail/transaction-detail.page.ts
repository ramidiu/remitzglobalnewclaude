...
<style>
  ...
  .ly-receipt .brand { text-align: center; font-size: 18px; font-weight: 700; color: #003377; margin-bottom: 20px; }
  .ly-receipt .ref-box { background: #f8f9fb; border-radius: 12px; text-align: center; padding: 18px; margin-bottom: 20px; }
  .ly-receipt .ref-box .ref { font-size: 17px; font-weight: 700; color: #003377; font-family: monospace; }
  ...
  .ly-receipt .transfer .amount { font-size: 22px; font-weight: 700; color: #003377; font-family: monospace; }
  ...
  .ly-receipt .section-title { font-size: 14px; font-weight: 700; color: #003377; padding: 16px 0 12px; border-bottom: 1px solid #e5e7eb; }
  ...
  .ly-receipt .row.total .rl { font-weight: 700; color: #003377; }
