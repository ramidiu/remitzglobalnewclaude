...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .brand { text-align: center; font-size: 20px; font-weight: 700; color: #003377; margin-bottom: 24px; }
  .ref-box { background: #f8f9fb; border-radius: 12px; text-align: center; padding: 20px; margin-bottom: 24px; }
  .ref-box .ref { font-size: 18px; font-weight: 700; color: #003377; font-family: monospace; }
  ...
  .transfer .amount { font-size: 24px; font-weight: 700; color: #003377; font-family: monospace; }
  ...
  .section-title { font-size: 15px; font-weight: 700; color: #003377; padding: 16px 0 12px; border-bottom: 1px solid #e5e7eb; }
  ...
  .row.total .rl { font-weight: 700; color: #003377; }
...
<div class="brand">Remitm Money Transfer — Transaction Receipt</div>
<div class="ref-box">
...
<div class="note">
  <span>&#x2705; This transfer was processed securely by Remitm Money Transfer. Keep this receipt for your records.</span>
</div>
</body></html>`;

    // Primary: download the backend-rendered branded PDF receipt (the Remitm receipt design).
  ...
  shareViaWhatsApp(): void {
    ...
    const msg = encodeURIComponent(
      `Join Remitm Money Transfer — send money internationally with great rates!${code ? ` Use my referral code *${code}* when you sign up and get a rate boost on your first transfer.` : ''} Download: https://remitm.com`
    );
