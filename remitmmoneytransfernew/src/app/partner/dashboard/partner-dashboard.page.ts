  ...
  template: `
    <div class="partner-dash">
      ...
      <div class="quick-actions">
        <ion-button fill="solid" style="--background:#003377;--color:#FFFFFF;--background-hover:#122550;--background-activated:#122550;" (click)="goTo('/partner/transactions')">
          <ion-icon name="time-outline" slot="start"></ion-icon>
          Pending Payouts
        </ion-button>
        <ion-button fill="outline" style="--border-color:#003377;--color:#003377;" (click)="goTo('/partner/completed')">
          <ion-icon name="checkmark-circle-outline" slot="start"></ion-icon>
          View Completed
        </ion-button>
        <ion-button fill="outline" style="--border-color:#003377;--color:#003377;" (click)="goTo('/partner/ledger')">
