...
@Component({
  ...
  styles: [`
    ...
    .rv-btn { display:inline-flex; align-items:center; gap:6px; padding:8px 16px; border-radius:8px; border:1px solid #003377; background:#fff; color:#003377; font-weight:600; cursor:pointer; font-size:0.9rem; }
    .rv-btn--primary { background:#003377; color:#fff; }
