...
@Component({
  ...
  <ion-content><div class="info-page">
    <div class="info-hero">
      ...
      <p>How to delete your Remitm Money Transfer account</p>
    </div>
    <div class="info-body">
      <p>Users may request deletion of their Remitm Money Transfer account through the mobile application under:</p>
      ...
      <h2>Need Help?</h2>
      <p>For assistance contact <a href="mailto:support@remitm.com">support@remitm.com</a>.</p>
