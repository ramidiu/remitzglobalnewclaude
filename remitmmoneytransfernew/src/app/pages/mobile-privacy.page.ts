...
@Component({
  ...
  <ion-content><div class="info-page">
    <div class="info-hero">
      ...
      <p>How the Remitm mobile app handles your data</p>
    </div>
    <div class="info-body">
      <p>This Mobile Privacy Policy explains how the Remitm Money Transfer mobile application, provided by Remitm Limited (Company Registration No: 07956213), collects and uses your information. It supplements our main <a href="/privacy-policy">Privacy Policy</a>.</p>
      ...
      <h2>Your Rights</h2>
      <p>You may request access, correction, or deletion of your data by emailing <a href="mailto:info@remitm.com">info@remitm.com</a>.</p>

      <h2>Changes</h2>
      <p>We may update this policy and will post changes here. Continued use of the app means you accept the updated policy.</p>
      <p class="info-muted">Remitm Limited, registered office: 20 Kirkdale Road, London, E11 1HP, United Kingdom. Tel: 020 8556 0888.</p>
    </div>
  </div></ion-content>`
})
