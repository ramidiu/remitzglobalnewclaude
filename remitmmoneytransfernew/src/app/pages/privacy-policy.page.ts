...
@Component({
  ...
  <ion-content><div class="info-page">
    ...
    <div class="info-body">
      <p>The money remittance service is provided by Remitm Limited (Company Registration No: 07956213) ("RemitM"). RemitM treats your privacy rights very seriously and will deal with any Personal Information you provide to us strictly in accordance with the privacy principles set out below. This Privacy Policy should be read in conjunction with the client agreement that you enter into with RemitM.</p>
      ...
      <p>Depending on your location, you may have rights to access your personal data, request correction or deletion, withdraw consent or object to data processing, and request data portability. To exercise these rights, contact us at <a href="mailto:info@remitm.com">info@remitm.com</a>.</p>
      ...
      <p><strong>Processing time:</strong> deletion requests are normally processed within 30 days. For assistance, contact <a href="mailto:support@remitm.com">support@remitm.com</a>.</p>
      ...
      <strong>Remitm Limited</strong><br>
      20 Kirkdale Road, London, E11 1HP, United Kingdom<br>
      Tel: <a href="tel:+442085560888">020 8556 0888</a><br>
      Email: <a href="mailto:info@remitm.com">info@remitm.com</a><br>
      Website: <a href="https://www.remitm.com">www.remitm.com</a></p>
