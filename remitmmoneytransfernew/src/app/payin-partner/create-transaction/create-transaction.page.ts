...
@Component({
  ...
  styles: [`
    ...
    .ct-back-btn { background:none; border:none; cursor:pointer; color:#003377; font-size:1.4rem; padding:4px 0; }
    ...
    .ct-step.active .ct-step__dot { background:#003377; color:#fff; }
    .ct-step.done .ct-step__dot { background:#10b981; color:#fff; }
    .ct-step__label { font-size:0.75rem; color:#6b7280; text-align:center; }
    .ct-step.active .ct-step__label { color:#003377; font-weight:600; }

    /* Card */
    .ct-card { background:#fff; border:1px solid #e5e7eb; border-radius:12px; padding:24px; box-shadow:0 1px 4px rgba(0,0,0,.06); }
    .ct-section-title { display:flex; align-items:center; gap:8px; font-size:1.05rem; font-weight:700; color:#003377; margin:0 0 20px; padding-bottom:12px; border-bottom:1px solid #f3f4f6; }
    ...
    .ct-change-btn { margin-left:auto; background:none; border:1px solid #003377; color:#003377; padding:3px 10px; border-radius:4px; cursor:pointer; font-size:0.8rem; }
    ...
    .ct-list-item:hover { border-color:#003377; background:#f8faff; }
    .ct-avatar, .ct-ben-avatar { width:36px; height:36px; border-radius:50%; background:#003377; color:#fff; display:flex; align-items:center; justify-content:center; font-size:0.85rem; font-weight:700; flex-shrink:0; }
    ...
    .ct-corridor-card--active { border-color:#003377; background:#f0f4ff; }
    ...
    .ct-rate-value { font-size:0.75rem; font-weight:700; color:#003377; white-space:nowrap; }
    ...
    .ct-pill:hover { border-color:#003377; color:#003377; }
    .ct-pill--active { border-color:#003377; background:#003377; color:#fff; }
    ...
    .ct-add-ben-btn:hover { border-color:#003377; color:#003377; }
    .ct-add-ben-form { border:1px solid #e5e7eb; border-radius:8px; padding:16px; margin-bottom:16px; }
    .ct-add-ben-title { font-size:0.9rem; font-weight:600; color:#003377; margin:0 0 14px; }
    ...
    .ct-field input:focus, .ct-field select:focus { border-color:#003377; }
    ...
    .ct-subsection { font-size:0.82rem; font-weight:700; color:#003377; text-transform:uppercase; letter-spacing:0.05em; margin:18px 0 10px; padding-top:8px; border-top:1px solid #f3f4f6; }
    ...
    .ct-kyc-row a { color:#003377; text-decoration:underline; }
    ...
    .ct-review-big { font-size:1.1rem; font-weight:700; color:#003377; }
    ...
    .ct-btn--outline:hover { border-color:#003377; color:#003377; }
    .ct-btn--primary { background:#003377; color:#fff; }
