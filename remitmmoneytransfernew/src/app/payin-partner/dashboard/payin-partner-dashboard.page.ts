  ...
  template: `
    <div class="payin-dash">
      ...
      <div class="quick-actions">
        <ion-button fill="solid" style="--background:#003377;--color:#FFFFFF;--background-hover:#122550;--background-activated:#122550;" (click)="goTo('/payin-partner/transactions')">
          <ion-icon name="swap-horizontal-outline" slot="start"></ion-icon>
          View Transactions
        </ion-button>
        <ion-button fill="outline" style="--border-color:#003377;--color:#003377;" (click)="goTo('/payin-partner/settlements')">
          <ion-icon name="wallet-outline" slot="start"></ion-icon>
          Submit Settlement
        </ion-button>
        <ion-button fill="outline" style="--border-color:#003377;--color:#003377;" (click)="goTo('/payin-partner/ledger')">
