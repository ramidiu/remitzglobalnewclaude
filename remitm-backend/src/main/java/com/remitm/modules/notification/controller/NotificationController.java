package com.remitm.modules.notification.controller;

import com.remitm.common.dto.ApiResponse;
import com.remitm.common.dto.DeviceRegistrationRequest;
import com.remitm.common.dto.InAppNotificationResponse;
import com.remitm.common.dto.PageResponse;
import com.remitm.security.JwtService;
import com.remitm.modules.notification.dto.DeviceResponse;
import com.remitm.modules.notification.service.DeviceService;
import com.remitm.modules.notification.service.InAppNotificationService;
...
public class NotificationController {
    ...
    private final com.remitm.modules.notification.service.NotificationPreferenceService preferenceService;
    ...
    public ResponseEntity<ApiResponse<com.remitm.modules.notification.dto.NotificationPreferenceResponse>> getPreferences(
            HttpServletRequest request) {
        Long userId = extractUserId(request);
        return ResponseEntity.ok(ApiResponse.<com.remitm.modules.notification.dto.NotificationPreferenceResponse>builder()
                .success(true)
    ...
    public ResponseEntity<ApiResponse<com.remitm.modules.notification.dto.NotificationPreferenceResponse>> updatePreferences(
            HttpServletRequest request,
            @RequestBody com.remitm.modules.notification.dto.NotificationPreferenceRequest body) {
        Long userId = extractUserId(request);
        return ResponseEntity.ok(ApiResponse.<com.remitm.modules.notification.dto.NotificationPreferenceResponse>builder()
                .success(true)
