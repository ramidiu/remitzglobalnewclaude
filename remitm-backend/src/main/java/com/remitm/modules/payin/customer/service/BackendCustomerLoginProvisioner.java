...
import com.remitm.modules.auth.repository.RoleRepository;
    ...
    public UserEntity provision(String firstName, String lastName, String email, String phone,
        ...
        if (existing != null) {
            ...
            if (existing.getKycTier() == null || existing.getKycTier().name().equals("TIER_0")) {
                existing.setKycTier(com.remitm.common.enums.KycTier.TIER_2);
            }
        ...
        UserEntity user = UserEntity.builder()
                ...
                .city(city)
                .postcode(postalCode)
                .userType(com.remitm.common.enums.UserType.INDIVIDUAL)
                .kycTier(com.remitm.common.enums.KycTier.TIER_2)   // trusted partner-created customer — always verified
                .status(com.remitm.common.enums.UserStatus.ACTIVE)
                .mfaEnabled(false)
                .emailVerified(true)
