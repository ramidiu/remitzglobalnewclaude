package com.remitm.modules.payin.customer.controller;
...
import com.remitm.modules.payin.customer.entity.PayinCustomerDocumentEntity;
            ...
            if (pc.getEmail() != null) {
                ...
                if (linked != null) {
                    if (linked.getKycTier() == null || linked.getKycTier().name().equals("TIER_0")) {
                        linked.setKycTier(com.remitm.common.enums.KycTier.TIER_2);
