...
import com.remitm.modules.transaction.service.TransactionReceiptService;
...
public class TransactionController {
    ...
    public ResponseEntity<ApiResponse<Page<TransactionResponse>>> listTransactions(
        ...
        TransactionListRequest request = TransactionListRequest.builder()
                .status(status != null ? com.remitm.common.enums.TransactionStatus.valueOf(status) : null)
