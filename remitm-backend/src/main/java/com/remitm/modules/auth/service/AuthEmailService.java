...
import com.remitm.modules.notification.service.ClickSendEmailSender;
...
public class AuthEmailService {
    ...
    private static final String LOGO_RESOURCE_PATH = "static/remitm-logo-email.png";
    private static final String LOGO_CID = "remitm-logo";
    ...
    @Value("${brand.name:Remitm Money Transfer}")
    ...
    @Value("${brand.support-email:support@remitm.com}")
    ...
    public void sendPasswordResetEmail(String to, String resetToken, String fullName) {
        clickSendEmailSender.send(to, brandName + " - Reset Your Password", buildPasswordResetHtml(resetToken, fullName));
    }

    @Async
    public void sendWelcomeEmail(String to, String fullName) {
        clickSendEmailSender.send(to, "Welcome to " + brandName + "!", buildWelcomeEmailHtml(fullName));
    }

    @Async
    public void sendOtpEmail(String to, String otp, String fullName) {
        clickSendEmailSender.send(to, brandName + " - Verify Your Email", buildOtpEmailHtml(otp, fullName));
    }
    ...
    public void sendDemoAccessEmail(String to, String firstName, String username, String password,
        ...
        clickSendEmailSender.send(to,
                brandName + " - Your demo access credentials",
                buildDemoAccessHtml(firstName, username, password, roleLabel, loginUrl, dashboardNote, expiresAt));
    }
                ...
                <tr>
                    <td style="background-color:#f7f9fc;padding:24px 30px;text-align:center;border-radius:0 0 12px 12px;border-top:1px solid #e2e8f0;">
                        ...
                        <p style="color:#718096;margin:0 0 6px;font-size:12px;text-align:center;">
                            ...
                            <a href="mailto:%s" style="color:#003377;text-decoration:none;">%s</a>
                        </p>
                    ...
                    <table role="presentation" width="100%%" cellspacing="0" cellpadding="0" style="max-width:600px;margin:0 auto;padding:40px 20px;">
                        ...
                        <tr>
                            <td style="background-color:#ffffff;padding:40px 30px;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                                <h2 style="color:#003377;margin:0 0 16px;font-size:22px;">Reset Your Password</h2>
                                <p style="color:#4a5568;margin:0 0 24px;font-size:16px;line-height:1.5;">
                                    Hi %s,<br><br>
                                    We received a request to reset your password. Click the button below to set a new password:
                                </p>
                                <div style="text-align:center;margin:0 0 24px;">
                                    <a href="%s" style="display:inline-block;background-color:#003377;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:8px;font-size:16px;font-weight:600;">
                                        Reset Password
                                    </a>
                                </div>
        ...
        return """
                ...
                <body style="margin:0;padding:0;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;background-color:#f4f6f9;">
                    <table role="presentation" width="100%%" cellspacing="0" cellpadding="0" style="max-width:600px;margin:0 auto;padding:40px 20px;">
                        ...
                        <tr>
                            <td style="background-color:#ffffff;padding:40px 30px;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                                <h2 style="color:#003377;margin:0 0 16px;font-size:22px;">Welcome to %s!</h2>
                                <p style="color:#4a5568;margin:0 0 24px;font-size:16px;line-height:1.5;">
                                    Hi %s,<br><br>
                                ...
                                <div style="background-color:#f0f4fa;border-radius:8px;padding:20px;margin:0 0 24px;">
                                    <h3 style="color:#003377;margin:0 0 12px;font-size:16px;">Get started in 3 steps:</h3>
        ...
        return """
                ...
                <body style="margin:0;padding:0;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;background-color:#f4f6f9;">
                    <table role="presentation" width="100%%" cellspacing="0" cellpadding="0" style="max-width:600px;margin:0 auto;padding:40px 20px;">
                        ...
                        <tr>
                            <td style="background-color:#ffffff;padding:40px 30px;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                                <h2 style="color:#003377;margin:0 0 16px;font-size:22px;">Verify Your Email</h2>
                                <p style="color:#4a5568;margin:0 0 24px;font-size:16px;line-height:1.5;">
                                    Hi %s,<br><br>
                                    Welcome to %s! Please use the following verification code to complete your registration:
                                </p>
                                <div style="background-color:#f0f4fa;border:2px dashed #003377;border-radius:8px;padding:20px;text-align:center;margin:0 0 24px;">
                                    <span style="font-size:36px;font-weight:700;color:#003377;letter-spacing:8px;">%s</span>
                                </div>
        ...
        return """
                ...
                <body style="margin:0;padding:0;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;background-color:#f4f6f9;">
                    <table role="presentation" width="100%%" cellspacing="0" cellpadding="0" style="max-width:600px;margin:0 auto;padding:40px 20px;">
                        ...
                        <tr>
                            <td style="background-color:#ffffff;padding:40px 30px;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                                <h2 style="color:#003377;margin:0 0 12px;font-size:22px;">Welcome, %s</h2>
                                <p style="color:#4a5568;margin:0 0 18px;font-size:15px;line-height:1.55;">
                                    Your demo access to %s is ready. You're signed up as a
                                    <strong style="color:#003377;">%s</strong>. %s
                                </p>

                                <div style="background:#f0f4fa;border:1px dashed #003377;border-radius:10px;padding:20px 22px;margin:20px 0;">
                                    ...
                                    <div style="font-size:18px;font-weight:700;color:#003377;font-family:ui-monospace,monospace;letter-spacing:1px;">%s</div>
                                ...
                                <div style="text-align:center;margin:26px 0 10px;">
                                    <a href="%s" style="display:inline-block;background-color:#003377;color:#ffffff;text-decoration:none;padding:14px 34px;border-radius:10px;font-size:15px;font-weight:600;">
                                        Sign in to %s
                                    </a>
                                </div>
