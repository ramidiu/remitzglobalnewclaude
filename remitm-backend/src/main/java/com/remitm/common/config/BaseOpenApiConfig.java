package com.remitm.common.config;
    ...
    public static OpenAPI createOpenAPI(String title, String description, String version) {
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version(version)
                        .contact(new Contact()
                                .name("Remitm Money Transfer Engineering")
                                .email("engineering@remitm.com")
                                .url("https://remitm.com"))
                        .license(new License()
                                .name("Proprietary")
                                .url("https://remitm.com/terms")))
                .servers(List.of(
                        new Server().url("http://localhost:8080").description("Local Development"),
                        new Server().url("https://remitm.com").description("Production")))
